                            ...
                            <form action="{{ route('tugas.update', $data->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="txtnama_tugas" value="{{ $data->nama_tugas }}" placeholder="Masukan Nama Tugas" class="form-control">
                                        @error('txtnama_tugas')
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="txtketerangan_tugas" value="{{ $data->ket_tugas }}" placeholder="Masukan Keterangan Tugas" class="form-control">
