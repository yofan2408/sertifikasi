                            ...
                            <form action="{{ route('pegawai.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="txtnama_pegawai" placeholder="Masukan Nama Pegawai" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="alamat" placeholder="Masukan Alamat Pegawai" class="form-control">
                                        @error('alamat')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
